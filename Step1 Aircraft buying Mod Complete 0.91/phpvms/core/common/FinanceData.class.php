...
class FinanceData extends CodonData {
    ...
    public static function calculateFinances($month_info) {
        ...
        $pay = LedgerData::getPaymentForMonth($month_info->timestamp);
        ...
        $month_info->payment = $pay;
        $month_info->revenue = $month_info->gross - $month_info->fuelprice - $month_info->pilotpay - $month_info->payment - $running_total ;
