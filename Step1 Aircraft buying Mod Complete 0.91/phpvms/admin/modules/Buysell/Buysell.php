...
class buysell extends CodonModule {
    ...
    public function viewmap() {
        ...
        if ($this->get->type === 'pirep') {
            ...
            $depicao = BuysellData::getAirportInfo($this->get->depicao);
            $arricao = BuysellData::getAirportInfo($this->get->arricao);
    ...
    public function editaircraft() {
        ...
        $this->set('aircraft', BuysellData::GetAircraftInfo($id));
	...
	public function buysellaircraft()
	{
		$id = $this->get->id;
				
		$this->set('aircraft', BuysellData::GetAircraftInfo($id));
		$this->set('title', 'Aircraft Buy/Sell');
		$this->set('action', 'editaircraft');
		$this->set('allranks', RanksData::getAllRanks());
		$this->render('ops_aircraftbuysell.tpl');	
	}	
	
public function repairaircraft()
	{
		$id = $this->get->id;
		...
		$this->set('action', 'editaircraft');
		$this->set('allranks', RanksData::getAllRanks());
		$this->render('ops_aircraftrepair.tpl');	
	}	
    ...
    public function editairline() {
        ...
        $this->set('airline', BuysellData::GetAirlineByID($this->get->id));
        $this->render('ops_airlineform.tpl');
    }

    /**
     * Buysell::calculatedistance()
     * 
    ...
    public function calculatedistance($depicao = '', $arricao = '') {
        ...
        echo BuysellData::getAirportDistance($depicao, $arricao);
    }

    /**
     * Buysell::getfuelprice()
     * 
     * @return
     */
    ...
    public function findairport() {
        ...
        $results = BuysellData::searchAirport($this->get->term);
    ...
    public function airlines() {
        ...
        $this->set('allairlines', BuysellData::GetAllAirlines());
    ...
    public function aircraft() {
        ...
        */
        ...
        $this->set('allaircraft', BuysellData::GetAllAircraft());
    ...
    public function editairport() {
        ...
        $this->set('airport', BuysellData::GetAirportInfo($this->get->icao));
        $this->render('ops_airportform.tpl');
    }
    /**
     * Buysell::airports()
    ...
    public function airports() {
        ...
        */
        ...
        //$this->set('airports', BuysellData::getAllAirports());
    ...
    public function airportgrid() {
        ...
        # http://dev.phpvms.net/admin/action.php/Buysell/
        ...
        $count = count(BuysellData::findAirport($where));
        ...
        $airports = BuysellData::findAirport($where, $limit, $start, "{$sidx} {$sord}");
        if (!$airports) {
            $airports = array();
        }
    ...
    public function addschedule() {
        ...
        if ($this->get->reverse == '1') {
            ...
            $schedule->distance = BuysellData::getAirportDistance($schedule->depicao, $schedule->arricao);
        ...
        $this->set('allairlines', BuysellData::GetAllAirlines());
        $this->set('allaircraft', BuysellData::GetAllAircraft());
        $this->set('allairports', BuysellData::GetAllAirports());
        //$this->set('airport_json_list', BuysellData::getAllAirportsJSON());
    ...
    public function schedulegrid() {
        ...
        foreach ($schedules as $row) {
            ...
            $edit = '<a href="' . adminurl('/Buysell/editschedule?id=' . $row->id) .
                '">Edit</a> <a href="' . adminurl('/Buysell/addschedule?reverse=1&id=' . $row->id) .
                '">Reverse</a>';
    ...
    protected function add_airline_post() {
        ...
        if (BuysellData::GetAirlineByCode($this->post->code)) {
            $this->set('message', 'An airline with this code already exists!');
            $this->render('core_error.tpl');
            return;
        }

        BuysellData::AddAirline($this->post->code, $this->post->name);
    ...
    protected function edit_airline_post() {
        ...
        $prevairline = BuysellData::GetAirlineByCode($this->post->code);
        ...
        BuysellData::EditAirline($this->post->id, $this->post->code, $this->post->name,
            $enabled);
    ...
    protected function add_aircraft_post() {
        ...
        $ac = BuysellData::GetAircraftByReg($this->post->registration);
        if ($ac) {
        ...
        $data = array(
			...
			'cond'=>$this->post->cond,
			'bought'=>$this->post->bought,
			'rep'=>$this->post->rep
            );

        BuysellData::AddAircraft($data);
    ...
    protected function edit_aircraft_post() {
        ...
        $ac = BuysellData::CheckRegDupe($this->post->id, $this->post->registration);
        if ($ac) {
            $this->set('message',
    ...
    protected function add_schedule_post() {
        ...
        if ($this->post->distance == '' || $this->post->distance == 0) {
            $this->post->distance = BuysellData::getAirportDistance($this->post->depicao,
                $this->post->arricao);
        }
